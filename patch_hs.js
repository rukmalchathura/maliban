...
let content = fs.readFileSync('src/components/health_safety.html', 'utf-8');
...
const init_old = `            q.answer = 'YES';
            q.severity = 'NONE';
            q.legalFlag = false;`;
const init_new = `            q.answer = 'YES';
            q.severity = 'NONE';
            q.legalFlag = false;
...
fs.writeFileSync('src/components/health_safety.html', content);
console.log("PATCHED");
